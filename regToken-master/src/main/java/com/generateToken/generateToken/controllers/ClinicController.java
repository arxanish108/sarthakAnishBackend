...
//    public String deleteClinic(@RequestParam Long id) {
//        System.out.println("hello");
//        String str = clinicService.deleteClinic(id);
//        return str;
//    }

    @PutMapping("update/{id}")
    public ResponseEntity<?> updateClinic(@PathVariable Long id, @RequestBody ClinicDto updatedClinicDto) {
        try {
